          ...
          <div className="e-con-inner">
            ...
            >
              <div className="elementor-widget-container">
                <Link href="https://3techy.com" aria-label="Home">
                  <img
                    src="/images/logo.svg"
                    alt="3Techy Logo"
                ...
                <nav className="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-vertical e--pointer-underline e--animation-grow">
                  <ul id="menu-1-750acc4" className="elementor-nav-menu sm-vertical">
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2641">
                      <Link href="https://3techy.com/service-areas/" className="elementor-item">
                        Service Areas
                      </Link>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2935">
                      <Link href="https://3techy.com/industries-serviced/" className="elementor-item">
                        Industries
                      </Link>
                    </li>
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-753">
                      <Link href="https://3techy.com/contact/" className="elementor-item">
                        Contact Us
                      </Link>
                    </li>
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-6256">
                      <Link
                        href="https://3techy.com/designer-referral-program/"
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-6257">
                      <Link
                        rel="privacy-policy"
                        href="https://3techy.com/privacy-policy/"
                        className="elementor-item"
                      >
                        Privacy Policy
                      </Link>
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-7716">
                      <Link
                        href="https://3techy.com/apply-to-work-at-3techy/"
                        className="elementor-item"
                      >
                ...
                <ul className="elementor-icon-list-items">
                  <li className="elementor-icon-list-item">
                    ...
                    <span className="elementor-icon-list-text">
                       Model Town Link Road,<br />Lahore, Pakistan
                    </span>
                  </li>
                  <li className="elementor-icon-list-item">
                  ...
                  <li className="elementor-icon-list-item">
                    <a href="mailto:contact@3techy.com">
                      ...
                      <span className="elementor-icon-list-text">contact@3techy.com</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="https://3techy.com">
                      <span className="elementor-icon-list-icon">
                        <svg
                          aria-hidden="true"
                      ...
                      <span className="elementor-icon-list-text">3techy.com</span>
                    </a>
                  </li>
                </ul>
              </div>
