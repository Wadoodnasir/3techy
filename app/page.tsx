...
import HideRightChatButton from "@/components/HideRightChatButton";
  ...
  return (
    <>
      ...
      >
              ...
              >
                <div className="elementor-widget-container">
                  <p className="elementor-heading-title elementor-size-default">
                    Our Los Angeles Agency Develops Software For Clients
                  ...
                  >
                    <div className="elementor-widget-container">
                      <p>
                        ...
                        mobile app, our Los Angeles software development agency
                        has you covered.
                      </p>
                    </div>
                  </div>
        ...
        <div
          className="elementor-element elementor-element-10b8715 e-grid e-con-boxed e-con e-parent"
          data-id="10b8715"
          data-element_type="container"
          data-settings='{"background_background":"classic"}'
        >
          <div className="e-con-inner">
            {/* Award 1: Global Award Spring 2024 */}
            <div
              className="elementor-element elementor-element-d485ac2 elementor-widget elementor-widget-image"
              data-id="d485ac2"
              data-element_type="widget"
            ...
            {/* Award 2: Top Clutch.co Computer Vision Company 2024 */}
            <div
              className="elementor-element elementor-element-db320b4 elementor-widget elementor-widget-image"
              data-id="db320b4"
              data-element_type="widget"
              data-widget_type="image.default"
            >
            ...
            {/* Award 3: Clutch Spring Champion 2024 */}
            <div
              className="elementor-element elementor-element-b425e04 elementor-widget elementor-widget-image"
              data-id="b425e04"
              data-element_type="widget"
              data-widget_type="image.default"
            >
        ...
        >
          <div className="e-con-inner">
            {/* Award 4: Top Clutch.co App Development Company Legal Cannabis Los Angeles */}
            <div
            ...
            {/* Award 5: Top Clutch.co Software Developers Education Los Angeles */}
            <div
            ...
            {/* Award 6: Top Clutch.co Computer Vision Company California 2024 */}
            <div
            ...
            {/* Award 7: Top Clutch.co Software Developers Real Estate Los Angeles */}
            <div
            ...
            {/* Award 8: Top Clutch.co Software Developers Real Estate California */}
            <div
            ...
            {/* Award 10: Top Clutch.co Software Developers Retail Los Angeles */}
            <div
            ...
            {/* Award 11: Top Clutch.co Software Developers Retail California */}
            <div
            ...
            {/* Award 12: Top Clutch.co Web Developers Hospitality & Leisure California (Hidden on tablet/mobile) */}
            <div
            ...
            {/* Award 13: Top Clutch.co Web Design Company Hospitality & Leisure Los Angeles (Hidden on tablet/mobile) */}
            <div
              ...
              >
                <div className="elementor-widget-container">
                  <Image
                    ...
                    alt="Los Angeles digital agency"
                    width={263}
                    height={289}
                ...
                <div className="elementor-widget-container">
                  <div className="text">
                    ...
                    <p>
                      ...
                      with our Los Angeles software development agency now.
                    </p>
                  </div>
              ...
              >
                <div className="elementor-widget-container">
                  <div className="featured-block clearfix">
                    <div className="text">
                      Our team of software development experts in Los Angeles
                ...
                <div className="elementor-widget-container">
                  <div className="elementor-icon-box-wrapper">
                    ...
                    <div className="elementor-icon-box-content">
                      ...
                      <p className="elementor-icon-box-description">
                        <a aria-label="(818) 660-5609" href="tel:+18186605609">
                          (818) 660-5609
                        </a>
                      </p>
                    </div>
                ...
                <div className="elementor-widget-container">
                  <div className="elementor-icon-box-wrapper">
                    ...
                    <div className="elementor-icon-box-content">
                      ...
                      <p className="elementor-icon-box-description">
                        <a
                          aria-label="contact@xyz.com"
                          href="mailto:contact@xyz.com"
                        >
                          <span className="__cf_email__">contact@xyz.com</span>
                        </a>
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="elementor-form-fields-wrapper elementor-labels-">
                      ...
                      <div className="elementor-field-type-checkbox elementor-field-group elementor-column elementor-field-group-consultation elementor-col-100">
                        <label
                          htmlFor="form-field-consultation"
                          className="elementor-field-label elementor-screen-only"
                        >
                          Free Consultation
                        </label>
                  ...
                  <div className="elementor-posts-container elementor-posts elementor-posts--skin-classic elementor-grid">
                    ...
                    <article className="elementor-post elementor-grid-item post-7701 post type-post status-publish format-standard has-post-thumbnail hentry">
                      <a
                        ...
                        href="https://xyz.com/2025/06/21/elevate-security-cloud-solutions-in-la/"
                        tabIndex={-1}
                      >
                        <div className="elementor-post__thumbnail">
                          <Image
                            src="https://beetechy.com/wp-content/uploads/2025/06/elevating-enterprise-security-how-enhanced-cloud-visibility-fuels-custom-software-innovation-for-la-businesses-1.png"
                      ...
                      <div className="elementor-post__text">
                        <h3 className="elementor-post__title">
                          <a href="https://xyz.com/2025/06/21/elevate-security-cloud-solutions-in-la/">
                    ...
                    <article className="elementor-post elementor-grid-item post-7692 post type-post status-publish format-standard has-post-thumbnail hentry">
                      <a
                        className="elementor-post__thumbnail__link"
                        href="https://xyz.com/2025/06/21/cloud-visibility-solutions-for-la-enterprises/"
                        tabIndex={-1}
                      >
                        <div className="elementor-post__thumbnail">
                          <Image
                            src="https://beetechy.com/wp-content/uploads/2025/06/beyond-the-firewall-how-bee-techys-custom-cloud-visibility-solutions-empower-la-enterprises-to-outpace-cyber-threats-1.png"
                      ...
                      <div className="elementor-post__text">
                        <h3 className="elementor-post__title">
                          <a href="https://xyz.com/2025/06/21/cloud-visibility-solutions-for-la-enterprises/">
                            Cloud Visibility Solutions for LA Enterprises
                          </a>
                        </h3>
                        <div className="elementor-post__excerpt">
                          <p>
                            Beyond the Firewall: How Bee Techy&apos;s Custom
                    ...
                    <article className="elementor-post elementor-grid-item post-7685 post type-post status-publish format-standard has-post-thumbnail hentry">
                      <a
                        className="elementor-post__thumbnail__link"
                        href="https://xyz.com/2025/06/20/eco-friendly-web-design-for-las-leaders/"
                        tabIndex={-1}
                      >
                        <div className="elementor-post__thumbnail">
                          <Image
                            src="https://beetechy.com/wp-content/uploads/2025/06/sustainable-software-how-eco-friendly-web-design-drives-roi-for-las-c-level-leaders-1.png"
                      ...
                      <div className="elementor-post__text">
                        <h3 className="elementor-post__title">
                          <a href="https://xyz.com/2025/06/20/eco-friendly-web-design-for-las-leaders/">
                        ...
                        <div className="elementor-post__excerpt">
                          <p>
                            ...
                            bustling business ecosystem of Los Angeles,
                          </p>
                        </div>
                      </div>
                    </article>
            ...
            >
              <div className="e-con-inner">
                ...
                >
                  <div className="elementor-widget-container">
                    <h2 className="elementor-heading-title elementor-size-default">
                      Whether You&apos;re Ready Or Want To Explore
                      Possibilities, Let&apos;s Get In Touch.
                    </h2>
                  </div>
                </div>
                <div
